let resumeData = {
    ...
    "name": "Alexander Ward",
    "role": "",
    "linkedinId":"https://www.linkedin.com/in/alex-sasha-ward/",
    "skypeid": "Your skypeid",
    "roleDescription": "Driven Software Engineer. Linguist. Technophile.",
    "socialLinks":[
        {
          "name":"linkedin",
          "url":"https://www.linkedin.com/in/alex-sasha-ward/",
    ...
    "portfolio":[
      {
        ...
        "githubRepo": "https://github.com/alexwardcodes/Project4-Agora-Frontend/blob/608f4b7883b279b13960eed62d9baf743682bab7/README.md",
        "text": "The aim of this project was to design an app using the MERN tech stack (MongoDB/Mongoose, Express, React and Node). Working with the same team as Django Djourneys plus another teammate, we came up with the idea of building a marketplace app that lets users sign up as buyers or sellers, add, update and delete items for sale, and view products with the option to add to them to their cart and purchase these. We split the app squarely between us: two of us working on the backend Express.js/Node.js and two teammates working on the React frontend. I worked with my teammate to build all of our backend APIs and tested these with Postman to check that our Mongo Atlas database was storing and sending the right information, then I assisted with the React components for the features I had worked on in the backend, such as the cart and product list.",
      ...
      },
      {
        ...
        "githubRepo": "https://github.com/alexwardcodes/Project3-DjangoDjourneys/blob/master/README.md",
        "text": "With my team and I seriously ready for a holiday and taking inspiration from the perfume brand Penhaligon's website, we thought: \"Wouldn't it be great if you could have an app that tells you what your next holiday destination should be?\". Django Djourneys is the result! Newcomers to the site can take a quiz that builds a \"profile\" to give them a list of destinations, which they can see individual details about such as reviews, weather and currency. Built over the course of a week in a team of three, we split the workload of our site equally by feature, writing our APIs in Python on the backend and calling these on the frontend in HTML within a Django framework. I used jQuery for our quiz feature and we styled the site using the Bootstrap library. I also took the role of team leader to manage the project flow and bug resolution.",
      ...
      },
      {
        ...
        "githubRepo": "https://github.com/alexwardcodes/Project2-RateMyCatApp/blob/master/README.md",
        "text": "With Rate My Cat, my team and I decided to go for a light-hearted concept - a full-stack app built in Express.js/Node.js where users can upload images of cats and have these rated by other users. Users can rate other people's cats, see other users, and there is also a leaderboard showing the most popular/highest rated cats. We split our workload evenly so we were all working on backend APIs as well as frontend template views, with all of us working to style the site. I also acted as team leader on this project, handling the overall development process and tracking tasks as well as bugs for resolution.",
      ...
      },
      {
        ...
        "githubRepo": "https://github.com/alexwardcodes/Project1-Odyssey/blob/main/README.md",
        "text": "Odyssey was my first ever project, a game built from scratch! Our brief was to build a game on our own within one week using HTML, CSS and DOM manipulation. I'm a huge mythology and folklore geek so I thought why not combine the two and make a Greek-influenced game? Besides, everyone loves a good riddle... I started with a basic HTML framework, then made extensive use of jQuery to build a game with animations, splitting the game into several distinct sequences which I then linked together with callback functions and styled with CSS.",
    ...
    "testimonials":[
      {
        "description":"I had the pleasure of working with Sasha during our capstone project for the Software Engineering Immersive course at General Assembly. Sasha is an incredibly talented and diverse software engineer with the ability to apply himself to any problem and find creative and elegant solutions, and learns and retains conceptual knowledge at speed. Alongside his technical knowledge, Sasha has been a true asset to his peers throughout the course, frequently acting as a support, teacher and debugger. I have no doubt that he will excel greatly in his next venture.",
        "name":"Ellie Eadington - General Assembly Student & Agora Teammate"
      },
      {
        "description":"I had the pleasure of working with Sasha on Project 2 at General Assembly for which he acted as Team Leader. Sasha was incredibly motivated and organised; he really propelled the project along and pushed us to create the best project we could. His knowledge even at that relatively early stage of the course was to be admired; he was a constant source of help and I lost count of the number of bugs he identified and fixed. He very clearly has a natural ability for programming and would be a perfect fit for any team.",
        "name":"Dan Emsley - General Assembly Student & Rate My Cat Teammate"
      },
      {
        "description":"I worked closely with Sasha on 2 full stack projects and I was impressed by his ability to focus on detail, get things done quickly, solve coding issues effortlessly and always in a good mood. A natural leader and a great person to work with. If you have the chance to work with Sasha, consider yourself a lucky person!",
        "name": "Claudia Eiko - General Assembly Student & Agora/Django Djourneys Teammate"
      },
      {
        "description":"I worked with Sasha on two projects during my time on the General Assembly SEI course. He is a pleasure to work with, super communicative and a very hard worker. His ability to grasp new concepts quickly and immediately integrate them into his work is really commendable. On top of consistently producing good work, Sasha always enjoys helping others in improving their understanding of a topic or when they are stuck with a bug or error (helped me plenty of times). He will be an asset to anyone that is lucky to work with him in the future.",
        "name": "Milos Jocic - General Assembly Student & Agora/Django Djourneys Teammate"
      },
      {
        "description": "It's been a pleasure to work with Sasha at General Assembly. He was a very dedicated and engaged student during the outcomes sessions through his Software Engineering course. Sasha has great communication skills, a positive attitude and pays attention to detail. He also always submitted his work on time and implemented the feedback quickly!",
        "name": "Astrid Haizet-Blanco - Senior Career Coach, General Assembly"
      }
    ]
  }
